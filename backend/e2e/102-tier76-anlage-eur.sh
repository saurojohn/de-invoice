...
#      (4100/4120/4170/4190).
#   3. All 6 BMF expense Kennziffern are present
#      (4300/5100/5400/5600/5800/5900).
...
echo
note "=== 3. expense Kennziffern 4300/5100/5400/5600/5800/5900 present ==="
EXP_KZS=$(python3 -c "
import json
d = json.load(open('$TMP'))
kzs = [l['kennziffer'] for l in d['ausgaben']]
print('true' if set(kzs) == {'4300', '5100', '5400', '5600', '5800', '5900'} else f'got: {sorted(kzs)}')
")
assert_eq "all 6 expense Kennziffern" "$EXP_KZS" "true"
