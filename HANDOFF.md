...
- **Repo:** github.com/saurojohn/de-invoice, branch `main`. Tiers 344–372 are
  in `git log`; §8 records what each learned. (Snapshot refreshed Tier 372.)
...
- **Test counts (last green CI, run 34850692636 / commit `726ef86`, Tier 372):**
  - Backend e2e: **172 passed / 0 failed / 1 skipped** of 173 specs — 100
    two-digit + 73 three-digit; before Tier 361 only the two-digit ones ever ran.
