...
- **Repo:** github.com/saurojohn/de-invoice, branch `main`. Tiers 344–391 are
  in `git log`; §8 records what each learned. (Snapshot refreshed Tier 391.)
...
- **Test counts (last green CI, run 35032619006 / commit `fb45594`, Tier 391):**
  - Backend e2e: **188 passed / 0 failed / 1 skipped** of 189 specs — 100
    two-digit + 89 three-digit (Tier 391 extended 50-webhooks.sh, no new spec file); before Tier 361 only the two-digit ones ever ran.
