...
- **Repo:** github.com/saurojohn/de-invoice, branch `main`. Tiers 344–397 are
  in `git log`; §8 records what each learned. (Snapshot refreshed Tier 397.)
...
- **Test counts (last green CI, run 35090119146 / commit `6810561`, Tier 397):**
  - Backend e2e: **188 passed / 0 failed / 1 skipped** of 189 specs — 100
    ...
    179-tier378-cross-tenant-ids.sh, 19-bulk-import.sh — and made 92
    self-sufficient; no new spec files); before Tier 361 only the two-digit ones ever ran.
