...
- **Test counts (last green CI, run 36147502937 / commit `5ffb676`, Tier 456):**
  - Backend e2e: **244 passed / 0 failed / 1 skipped** of 245 specs — 100
    two-digit + 145 three-digit (Tier 456 added `245-tier456-guthaben-auszahlung.sh`,
  ...
  - Playwright: **943 passed / 0 failed / 0 skipped / 0 flaky** (Tier 428's
    ...
    passed on retry). 943 tests (922 since Tier 390's
    ...
    Tier 448's ustva-berichtigt spec; +1 each in Tiers 449, 450, 451, 452, 453, 454 and 455). Tier 365 turned the last 4 skips into real
